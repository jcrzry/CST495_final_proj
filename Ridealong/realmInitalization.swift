...
//            let perms = SyncPermission(realmPath: commonUrlString, userID: "*", accessLevel: .read)
//            user?.apply(perms){
//                error in
//                if let error = error{
//                    print(error)
...
//                    let wperms = SyncPermission(realmPath: commonUrlString, userID: "*", accessLevel: .write)
